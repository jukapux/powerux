...
## Etap 1 gotowy do uruchomienia
Dodałem gotowe materiały do pierwszej masowej optymalizacji:
- `optimization/STAGE1_PLAN.md` – pełna instrukcja krok po kroku (zakresy, kolejność passów, filtry jakości, scoring),
- `optimization/stage1_baseline.set` – plik startowy `.set` do MT5.

Rekomendacja: uruchom najpierw Pass A/B/C zgodnie z planem, a top wyniki przejdą do etapu 2 (fine tuning).
